<script>
    ...
    function secretpin(scrpin, objID) {
        ...
        serverPage = '<?php echo base_url() ?>AP_Panel/level_ten_pin_check/' + scrpin;
...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
        	<h1 class="text-center">APPLY FOR LEVEL ten PIN</h1>
			<hr>
			<div class="col-md-6 col-md-offset-3">
				<div class="apply-level">
					<form action="<?php echo base_url() ?>AP_Panel/level_ten_random" method="post">
